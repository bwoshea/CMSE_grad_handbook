...
\item Of the two departments involved, one must be the student's
  ...
  (Their primary thesis advisor can be in either department.)  The
...
\item \textbf{Qualifying Exam:} Students whose primary department is
  ...
  detailed in the CMSE program description), and students whose
...
\item \textbf{Cognate coursework requirement:}  Students must
  determine, in discussion with their thesis committee, a
  ...
  discretion of the thesis committee.
...
\item \textbf{Thesis Committee:} Students must form a PhD thesis
  ...
  possible the requirements for the composition of a thesis committee
  from both departments.  The thesis committee must include at least
  one faculty program advisor whose tenure home is in each of the two
  departments.  The thesis committee must be formed and meet prior to
...
\item \textbf{Comprehensive Exam:}  Comprehensive examinations are
  ...
  in CMSE is the first formal meeting of the thesis committee and a
  presentation of the thesis proposal (although see the previous
  ...
  thesis committee meeting, this meeting should explicitly include
  ...
  thesis committee meeting.  This requirement should be fulfilled
...
requirements specified in the CMSE PhD program description with
regards to the number of opportunities to pass exams, GPA
